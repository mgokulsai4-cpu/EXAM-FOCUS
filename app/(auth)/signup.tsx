...
export default function SignUpScreen() {
  ...
  const entrance6 = useStaggeredEntrance(5, 100);
  ...
  return (
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        ...
        <Animated.View style={[styles.termsContainer, containerStyle, entrance3]}>
        ...
        <Animated.View style={[styles.buttonContainer, containerStyle, entrance4]}>
          <AnimatedButton
        ...
        <Animated.View style={[styles.dividerContainer, containerStyle, entrance5]}>
        ...
        <Animated.View style={[styles.loginContainer, containerStyle, entrance6]}>
...
const styles = StyleSheet.create({
  ...
  termsContainer: { width: '100%', marginBottom: 24, paddingHorizontal: 4 },
  termsText: { fontSize: 12, color: 'rgba(255,255,255,0.4)', textAlign: 'center', lineHeight: 20, fontFamily: 'Inter_500Medium' },
  termsLink: { color: '#0ea5e9', fontWeight: '600', fontFamily: 'Inter_600SemiBold' },
  ...
  loginText: { fontSize: 14, color: 'rgba(255,255,255,0.5)', fontFamily: 'Inter_500Medium' },
  loginLink: { fontSize: 14, fontWeight: '700', color: '#0ea5e9', fontFamily: 'SpaceGrotesk_700Bold' },
});